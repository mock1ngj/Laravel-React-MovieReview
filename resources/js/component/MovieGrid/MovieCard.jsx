    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-col mb-3">
                ...
                <textarea ref={comment} id="comment" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" rows="3" placeholder="Comment"></textarea>
            </div>
